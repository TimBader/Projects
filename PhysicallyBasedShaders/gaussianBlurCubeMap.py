...
print("uniform samplerCube cubeMap;");
print("uniform vec4 basetexture_size;")
...
m=-r
for q in A:
    print("    color +=",q,"* getColor(v_texcord.st +",m,end=" ")
    print("* deltas*basetexture_size.z, cubeMap, dVec, axisSelect);")
    m += 2.0*r/(Alen-1)
